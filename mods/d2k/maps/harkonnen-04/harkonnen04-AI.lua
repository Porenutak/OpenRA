...
ActivateAI = function()
	...
	GuardSquad[Atreides] = {}
	GuardSquad[Fremen] = {}
	GuarSquadUnitLimit[Atreides] = AttackGroupSize[Difficulty] * 2
	GuarSquadUnitLimit[Fremen] = 0
	DefensePerimeter[Atreides] = GetCellsInRectangle(CPos.New(4,68), CPos.New(44, 81))
	PatrolPoints[Atreides] = {APatrolPoint01, APatrolPoint02, APatrolPoint03, APatrolPoint04, APatrolPoint05}
	IdlingUnits[Fremen] = { }
