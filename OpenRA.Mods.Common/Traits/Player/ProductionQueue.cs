...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class ProductionQueueInfo : TraitInfo, IRulesetLoaded
	{
		...
		[Desc("Item is blocked if player can't pay up front, relevant only if PayUpFront is True.")]
		public readonly bool BlockedIfInsolvent = false;
	...
	public class ProductionQueue : IResolveOrder, ITick, ITechTreeElement, INotifyOwnerChanged, INotifyKilled, INotifySold, ISync, INotifyTransform, INotifyCreated
	{
		...
		public virtual IEnumerable<ActorInfo> BuildableItems()
		{
			...
			if (developerMode.AllTech)
				return Producible.Keys;
			if (!Info.PayUpFront || !Info.BlockedIfInsolvent)
			{
	...
	public class ProductionItem
	{
		...
		public readonly bool PaidUpFront;

		public readonly bool BlockedIfInsolvent;
		...
		public ProductionItem(ProductionQueue queue, string item, int cost, PowerManager pm, Action onComplete)
		{
			...
			Queue = queue;
			PaidUpFront = queue.Info.PayUpFront;
			BlockedIfInsolvent = queue.Info.BlockedIfInsolvent;
			this.pm = pm;
